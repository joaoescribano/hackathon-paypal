		...
		<div class="row">
			<div class="large-12 columns">
				...
				<div data-alert class="alert-box success radius">
					<b>Sucesso: </b><?php echo $_GET['sucesso']; if (isset($_GET['status']) && $_GET['status'] == "Completed") { echo "<br/><br/>Caso deseje cancelar esta assinatura, <a href='cancelarAssinatura.php'>Clique Aqui</a>"; } ?>
					<a href="#" class="close">&times;</a>
				</div>
			</div>
		</div>
		...
		<div class="large-12 columns">
			<table width="100%">
				...
				<tbody>
					<?php
					$total = 0;
					foreach ($_SESSION['recurring'] as $key => $produto) {
						...
						<tr>
							...
							<td class="text-center"><a href="remover.php?assinatura=1&item=<?php echo $key; ?>" class="button radius tiny alert">X</a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
			...
			<div class="large-12 columns">
				...
				<br/>
				<br/>
				<a href="checkoutAssinatura.php" class="right" style="margin-left: 1em;"><img src="img/botao-checkout_horizontal_finalizecom_ap.png" alt="Finalizar Compra com PayPal"></a>
				<a href="carrinhoAsinatura.php?erro=Funcionalidade Inexistente" class="button radius tiny right" style="margin-left: 1em;">Finalizar Compra</a>
